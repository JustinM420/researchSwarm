...
researcher = GPTAssistantAgent(
    ...
    llm_config = {
        ...
        "assistant_id": "asst_1aVH4uzY22aClIBcNtwq5aeW"
    }
)
...
research_manager = GPTAssistantAgent(
    ...
    llm_config = {
        "config_list": config_list,
        "assistant_id": "asst_g2QRCrAcg4fKFz3dtI2iUsWX"
    }
)
...
director = GPTAssistantAgent(
    ...
    llm_config = {
        "config_list": config_list,
        "assistant_id": "asst_8jp2mwxhhZgtR6CVQZemxAni",
    }
)
...
# ------------------ start conversation ------------------ #
message = """
Research each topic found in the search term column: https://airtable.com/appivA9pi9RekcJHm/tbljwamwnQGRXLfRO/viwZQvrFlNz9fJlqu?blocks=hide
"""
